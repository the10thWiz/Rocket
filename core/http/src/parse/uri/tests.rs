...
fn single_byte() {
    assert_parse_eq!(
        ...
        "%" => Authority::new(None, "%", None),
        "?" => Reference::new(None, None, None, None, "", "", None),
        "#" => Reference::new(None, None, None, None, "", None, ""),
...
fn absolute() {
    assert_parse_eq! {
        "http:/" => Absolute::new("http", None, None, None, "/", None),
        "http://" => Absolute::new("http", None, "", None, "", None),
        "http:///" => Absolute::new("http", None, "", None, "/", None),
        "http://a.com:8000" => Absolute::new("http", None, "a.com", 8000, "", None),
        "http://foo:8000" => Absolute::new("http", None, "foo", 8000, "", None),
        "foo:bar" => Absolute::new("foo", None, None, None, "bar", None),
        "ftp:::" => Absolute::new("ftp", None, None, None, "::", None),
        "ftp:::?bar" => Absolute::new("ftp", None, None, None, "::", "bar"),
        "http://:::@a.b.c.:8000" =>
            Absolute::new("http", ":::", "a.b.c.", 8000, "", None),
        "http://sergio:pass@foo.com:8000" =>
            Absolute::new("http", "sergio:pass", "foo.com", 8000, "", None),
        "foo:/sergio/pass?hi" => Absolute::new("foo", None, None, None, "/sergio/pass", "hi"),
        "foo:?hi" => Absolute::new("foo", None, None, None, "", "hi"),
        "foo:a/b" => Absolute::new("foo", None, None, None, "a/b", None),
        "foo:a/b?" => Absolute::new("foo", None, None, None, "a/b", ""),
        "foo:a/b?hi" => Absolute::new("foo", None, None, None, "a/b", "hi"),
        "foo:/a/b" => Absolute::new("foo", None, None, None, "/a/b", None),
        ...
        "ftp://foo.com:21/abc" =>
            Absolute::new("ftp", None, "foo.com", 21, "/abc", None),
        "http://rocket.rs/abc" =>
            Absolute::new("http", None, "rocket.rs", None, "/abc", None),
        "http://s:b@rocket.rs/abc" =>
            Absolute::new("http", "s:b", "rocket.rs", None, "/abc", None),
        "http://rocket.rs/abc?q" =>
            Absolute::new("http", None, "rocket.rs", None, "/abc", "q"),
        "http://rocket.rs" =>
            Absolute::new("http", None, "rocket.rs", None, "", None),
        "git://s::@rocket.rs:443/abc?q" =>
            Absolute::new("git", "s::", "rocket.rs", 443, "/abc", "q"),
        "git://:@rocket.rs:443/abc?q" =>
            Absolute::new("git", ":", "rocket.rs", 443, "/abc", "q"),
        "a://b?test" => Absolute::new("a", None, "b", None, "", "test"),
        "a://b:?test" => Absolute::new("a", None, "b", 0, "", "test"),
        "a://b:1?test" => Absolute::new("a", None, "b", 1, "", "test"),
    };
}
...
fn reference() {
    assert_parse_eq!(
        "*#" => Reference::new(None, None, None, None, "*", None, ""),
        "*#h" => Reference::new(None, None, None, None, "*", None, "h"),
        "@/" => Reference::new(None, None, None, None, "@/", None, None),
        "@?" => Reference::new(None, None, None, None, "@", "", None),
        "@?#" => Reference::new(None, None, None, None, "@", "", ""),
        "@#foo" => Reference::new(None, None, None, None, "@", None, "foo"),
        "foo/bar" => Reference::new(None, None, None, None, "foo/bar", None, None),
        "foo/bar?baz" => Reference::new(None, None, None, None, "foo/bar", "baz", None),
        "foo/bar?baz#cat" => Reference::new(None, None, None, None, "foo/bar", "baz", "cat"),
        "a?b#c" => Reference::new(None, None, None, None, "a", "b", "c"),
        "?#" => Reference::new(None, None, None, None, "", "", ""),
        "ftp:foo/bar?baz#" => Reference::new("ftp", None, None, None, "foo/bar", "baz", ""),
        "ftp:bar#" => Reference::new("ftp", None, None, None, "bar", None, ""),
        "ftp:?bar#" => Reference::new("ftp", None, None, None, "", "bar", ""),
        "ftp:::?bar#" => Reference::new("ftp", None, None, None, "::", "bar", ""),
        "#foo" => Reference::new(None, None, None, None, "", None, "foo"),
        "a:/#" => Reference::new("a", None, None, None, "/", None, ""),
        "a:/?a#" => Reference::new("a", None, None, None, "/", "a", ""),
        "a:/?a#b" => Reference::new("a", None, None, None, "/", "a", "b"),
        "a:?a#b" => Reference::new("a", None, None, None, "", "a", "b"),
        "a://?a#b" => Reference::new("a", None, "", None, "", "a", "b"),
        "a://:?a#b" => Reference::new("a", None, "", 0, "", "a", "b"),
        "a://:2000?a#b" => Reference::new("a", None, "", 2000, "", "a", "b"),
        "a://a:2000?a#b" => Reference::new("a", None, "a", 2000, "", "a", "b"),
        "a://a:@2000?a#b" => Reference::new("a", "a:", "2000", None, "", "a", "b"),
        "a://a:@:80?a#b" => Reference::new("a", "a:", "", 80, "", "a", "b"),
        "a://a:@b:80?a#b" => Reference::new("a", "a:", "b", 80, "", "a", "b"),
    );
}
